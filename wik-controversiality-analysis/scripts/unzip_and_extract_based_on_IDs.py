...
folder_out = "/work/wikidata/n11206756/extracted_files/"
...
def find_file(page_ID):
    # we get
    files = glob.glob(folder_in+"enwiki-20240201-pages-meta-history*.7z")
    for file in files:
...
folder (string): full path to the output folder
